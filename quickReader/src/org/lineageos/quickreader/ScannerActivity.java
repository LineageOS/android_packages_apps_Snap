...
public class ScannerActivity extends Activity implements ZXingScannerView.ResultHandler {
    ...
    private void showRationaleErrorDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.quick_reader_permission_rationale_positive, (dialog, i) -> requestPermission())
                .setNegativeButton(R.string.quick_reader_action_dismiss, ((dialog, i) -> finish()))
                .show();
    }
    ...
    private void showFatalErrorDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.quick_reader_permission_fatal_positive, (dialog, i) -> openSettings())
                .setNegativeButton(R.string.quick_reader_action_dismiss, ((dialog, i) -> finish()))
                .show();
    }
    ...
    private static class AnalyzeTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            if (content.startsWith("smsto:")) {
                ...
                sHelper.setContactIntent(content.replace("MECARD:", ""), false);
                icon = R.drawable.ic_contact;
            } else {

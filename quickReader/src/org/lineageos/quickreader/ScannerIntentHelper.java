...
class ScannerIntentHelper {
    ...
    private void showScannedText(Context context) {
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.quick_reader_scanned_text_positive, (dialog, i) -> copyScanned(context))
                .setNegativeButton(R.string.quick_reader_scanned_text_negative, (dialog, i) -> shareScanned(context))
                .show();
    }

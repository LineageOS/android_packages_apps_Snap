...
public class OneUICameraControls extends RotatableLayout {
    ...
    public OneUICameraControls(Context context, AttributeSet attrs) {
        ...
        mTop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 64,
                getResources().getDisplayMetrics());
        mBottom = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 100,
                getResources().getDisplayMetrics());
        mVisible = true;
    ...
    private void setLocationCameraModePanel() {
        ...
        Log.v("loc", Float.toString(mModeSwitcher.getY()));
        Log.v("loc", Float.toString(mModeSelectLayout.getMeasuredHeight()));
        Log.v("loc", Float.toString(mModeSelectLayout.getY()));
    }

...
public abstract class BaseUI {
    ...
    protected void hideUI(boolean toBlack) {
        if (mPreviewCover != null) {
            ...
            if (toBlack) {
                setPreviewCoverAlpha(1.0f);
            } else {
                setPreviewCoverAlpha(0.4f);
            }
            if (mCameraControls != null) {
    ...
    private void setPreviewCoverAlpha(float alpha) {
        ...
        synchronized (mPreviewCover) {
            ...
            Log.d(TAG, "setPreviewCoverAlpha alpha=" + alpha + " current=" + mPreviewCoverAlpha);

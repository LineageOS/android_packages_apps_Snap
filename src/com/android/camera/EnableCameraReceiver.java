...
// We want to enable camera-related activities if there is a camera. This
...
public class EnableCameraReceiver extends BroadcastReceiver {
    private static final String TAG = "EnableCameraReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // Enable camera-related activities if there is a camera.
        ...
        if (needCameraActivity) {
            ...
            for (int i = 0; i < ACTIVITIES.length; i++) {
                enableComponent(context, ACTIVITIES[i], true);
            }
        }

        // Disable this receiver so it won't run again.
        enableComponent(context, "com.android.camera.EnableCameraReceiver", false);
    }
